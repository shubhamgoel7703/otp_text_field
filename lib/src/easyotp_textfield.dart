...
class EasyOtpTextField extends StatefulWidget {
...
class _OtpTextFieldState extends State<EasyOtpTextField> {
  ...
  @override
  void didUpdateWidget(covariant EasyOtpTextField oldWidget) {
